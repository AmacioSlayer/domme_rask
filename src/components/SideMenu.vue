<template>
  <aside class="menu_side">
    ...
    /></a>
    <b-nav vertical class="menu_side_list">
      <b-nav-item>
        <svg
          class="menu_side_img"
          width="24"
...
/* ----- Doesn't work -----
.menu_side_img:hover {
  fill: rgba(91, 108, 255, 0.4);
}
.menu_side_img:active {
  fill: rgba(91, 108, 255, 1);
} */
.menu_side_list .nav-link {
...
.nav-link:hover {
  color: rgba(91, 108, 255, 0.4) !important;
...
.nav-link:active,
.nav-link:focus {
  color: rgba(91, 108, 255, 1) !important;
  background-image: linear-gradient(
    90deg,
